...
url = 'http://192.168.125.127:8080/video'
...
# Initialize time variables for performance monitoring
prev_time = time.time()
frame_count = 0
...
while True:
    ...
    if current_time - prev_time >= 1:  # Calculate FPS every 1 second
        print("FPS:", frame_count / (current_time - prev_time))
