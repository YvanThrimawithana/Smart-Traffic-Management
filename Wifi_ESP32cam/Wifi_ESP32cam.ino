...
const char* WIFI_SSID[] = { "Yvan", "Amar"}; // Array of WiFi SSIDs
const char* WIFI_PASS[] = { "12345678", "12345678"}; // Array of corresponding WiFi passwords
const int NUM_WIFI_NETWORKS = 2; // Number of WiFi networks
